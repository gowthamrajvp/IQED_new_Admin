...
//
import KanbanTaskAdd from '../SyllabusTaskAdd';
import KanbanTaskCard from '../SyllabusTaskCard';
import KanbanColumnToolBar from './SyllabusColumnToolBar';

// ----------------------------------------------------------------------

SyllabusColumn.propTypes = {
  cards: PropTypes.object,
  index: PropTypes.number,
  column: PropTypes.object,
};

export default function SyllabusColumn({ column, index, cards }) {
