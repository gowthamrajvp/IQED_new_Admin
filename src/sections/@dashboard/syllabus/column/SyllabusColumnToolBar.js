...
import SyllabusInputDescription from '../SyllabusInputDescription';

// ----------------------------------------------------------------------

SyllabusColumnToolBar.propTypes = {
  columnName: PropTypes.string,
  onDelete: PropTypes.func,
  onUpdate: PropTypes.func,
};

export default function SyllabusColumnToolBar({ columnName, onDelete, onUpdate }) {
