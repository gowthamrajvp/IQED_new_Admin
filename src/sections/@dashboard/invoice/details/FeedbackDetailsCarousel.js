...
FeedbackDetailsCarousel.propTypes = {
  Images: PropTypes.object,
};

export default function FeedbackDetailsCarousel({ Images }) {
  ...
  const renderLargeImg = (
    <Box sx={{ mb: 3, borderRadius: 2, overflow: 'hidden', position: 'relative',justifyContent:'center' }}>
