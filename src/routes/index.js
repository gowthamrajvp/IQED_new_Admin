    ...
    // Dashboard
    {
      ...
      children: [
        ...
        // },
        {
          path: 'challenge',
          children: [
            { element: <Navigate to="/dashboard/challenge/list" replace />, index: true },
            { path: 'list', element: <ChallengesPage /> },
            // { path: ':name', element: <ChallengeDetailsPage /> },
            { path: 'orders', element: <ChallengeListPage /> },
            { path: 'new', element: <ChallengeCreatePage/> },
            { path: ':name/edit', element: <ChallengeEditPage /> },
          ],
        },
        {
          path: 'user',
