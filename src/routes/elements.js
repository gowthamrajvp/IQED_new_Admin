...
export const FeedbackDetailsPage = Loadable(
  lazy(() => import('../pages/dashboard/FeedbackDetailsPage'))
);
...
export const SamplePage = Loadable(lazy(() => import('../pages/dashboard/SamplePage')));
